<section class="header">
    <div class="row pt-5 c-mr-0">
        <div class="col-md-4 col-8 ps-10 logo">
            <a href="{{route('/')}}"><img src="{{asset('frontEndAsset')}}/image/logo.png" alt=""></a>
        </div>
        <div class="col-md-8 col-4 pe-10 c-ps-10">
    ...
    <div class="row c-mr-0">
        <div class="col-md-12">
            <div class="text-box text-center">
                ...
                <a href="" class="btn btn-outline-primary mt-4 hero-btn">visit Us To know More</a>
            </div>
        </div>
    </div>
